...
# ─────────────────────────────────────────
#  Стиль (наближений до зразку Маркевича)
# ─────────────────────────────────────────
plt.rcParams.update({
...
SCATTER_COLOR = '#d4a017'   # золотисті точки як у зразку
IDEAL_COLOR   = '#e63946'   # червона штрихова лінія «Ідеальний прогноз»
CMAP = 'viridis'
...
# ══════════════════════════════════════════════════════════════
#  РИСУНОК 1 — Scatter (окреме вікно/файл)
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
#  РИСУНОК 2 — 3D поверхні: справжня vs сурогатна (окремий файл)
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
#  РИСУНОК 3 — Збіжність RBF (окремий файл)
# ══════════════════════════════════════════════════════════════
...
# ══════════════════════════════════════════════════════════════
#  РИСУНКИ 4–6 — Scatter для кожного типу RBF (окремі файли)
# ══════════════════════════════════════════════════════════════
