...
# ── Графік 1: три сценарії SEIRD (тепер кожен окремо) ─────
...
# ── Графік 2: ДІАГРАМИ РОЗСІЮВАННЯ (кожна окремо) ──────────
...
# ── Графік 4: 3D-ПОВЕРХНІ (кожна окремо) ──────────────────
...
# ── Графік 5: початкове vs оптимальне (два окремі графіки) ─
